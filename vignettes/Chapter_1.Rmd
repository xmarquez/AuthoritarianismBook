...
It also assumes you have the `dplyr` and `ggplot2` packages installed:
...
ggplot(data = data, aes(x = civil_society,y = personal_power, color = communist)) +
