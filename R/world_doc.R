...
#'
#'
#' \item{lat}{Latitude. Numeric. Max = 83.645, min = -90, distinct = 9907, mean =
...
#'
#'
#' \item{piece}{piece Factor with 30 levels. Most common: 1 (9732), 2 (917), 3
#' (427), 4 (232), 5 (179), 6 (116), 8 (112). NAs = 0.}
#'
#'
#' \item{id}{id Character with 242 distinct values. Most common: Antarctica (661),
#' Canada (795), Russia (Soviet Union) (598). NAs = 0.}
#'
#'
#' \item{group}{group Factor with 454 levels. Most common: Antarctica.1 (556),
