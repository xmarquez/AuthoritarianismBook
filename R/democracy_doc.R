...
#' \\link{QuickUDS} for further documentation.
#'
...
#'
#'
#' \item{arat_pmm}{Democracy score Arat (1991). Taken from Pemstein, Meserve, and
...
#'
#'
#' \item{bmr_democracy}{Dichotomous measure of regime type from Boix, Miller, and
#' Rosato (2012). Numeric. Max = 1, min = 0, distinct = 3, mean = 0.319, sd =
#' 0.466, NAs = 7189.}
#'
#'
#' \item{bmr_democracy_omitteddata}{Dichotomous measure of regime type from Boix,
...
#'
#'
#' \item{bollen_pmm}{0-100 index of democracy from Bollen (2001). Taken from
#' Pemstein, Meserve, and Melton (2013). Numeric. Max = 100, min = 0, distinct =
#' 349, mean = 55.457, sd = 33.696, NAs = 23665.}
#'
#'
#' \item{doorenspleet}{Dichotomous index of democracy from Doorenspleet (2000). 1
...
#' \url{http://www.govindicators.org}. Numeric. Max = 0.965, min = 0, distinct =
#' 789, mean = 0.467, sd = 0.243, NAs = 21774.}
#'
#'
#' \item{freedomhouse}{Average civil liberties + political rights score (reversed
...
#' data available at \url{http://www.freedomhouse.org}. Goes from 1 (least
...
#'
#'
#' \item{gwf}{Dichotmous democracy/autocracy indicator from Geddes, Wright, and
...
#'
#'
#' \item{hadenius_pmm}{0-10 index of democracy from Hadenius 1992. Taken from
...
#'
#'
#' \item{kailitz_binary}{Dichotomous democracy indicator from Kailitz 2013. 1 =
...
#'
#'
#' \item{kailitz_tri}{Trichotomous democracy indicator from Kailitz 2013. 1 =
...
#'
#'
#' \item{lied}{0-6 Lexical Index of Electoral Democracy from Skaaning, Gerring,
...
#'
#'
#' \item{magaloni_regime_tri}{Trichotomous democracy indicator from Magaloni, Chu,
...
#'
#'
#' \item{mainwaring}{Trichotomous democracy indicator from Mainwaring, Brinks, and
#' Perez Linan (2008).  -1 = non-democracy, 0 = hybrid, 1 = democracy. Numeric.
#' Max = 1, min = -1, distinct = 4, mean = -0.325, sd = 0.838, NAs = 22019.}
#'
#'
#' \item{munck_pmm}{0-1 index of democracy from Munck 2009. Taken from Pemstein,
...
#'
#'
#' \item{pacl}{Dichotomous measure of democracy from Cheibub, Gandhi, and Vreeland
...
#'
#'
#' \item{pitf}{A five category indicator of democracy described in Goldstone et al
#' 2010. Can be:
#'
...
#'
#'
#' \item{prc}{1-4 index of democracy from Gasiorowsk 1996. Available in updated
...
#'
#'
#' \item{prc_notrans}{Same as prc but sets all 2 (transition) regimes to NA.
#' Numeric. Max = 4, min = 1, distinct = 4, mean = 2.002, sd = 1.31, NAs = 13292.}
#'
#'
#' \item{svolik}{Dichotomous indicator of democracy from Svolik 2012. 1 =
...
#'
#'
#' \item{ulfelder}{Dichotomous indicator of democracy from Ulfelder 2012. 0 =
#' authoritarian, 1 = democracy. Numeric. Max = 1, min = 0, distinct = 3, mean =
#' 0.412, sd = 0.492, NAs = 16491.}
#'
#'
#' \item{utip_dichotomous}{Calculated dichotomous index of democracy from data in
...
#'
#'
#' \item{utip_dichotomous_strict}{Stricter version of the calculated dichotomous
...
#'
#'
#' \item{utip_trichotomous}{Calculated trichotomous index of democracy from data
...
#'
#'
#' \item{v2x_api}{Additive polyarchy index from V-dem version 6.1 (Coppedge at al
...
#'
#'
#' \item{vanhanen_democratization}{Index of democratization from Vanhanen 2012.
...
#'
#'
#' \item{vanhanen_participation}{Index of participation from Vanhanen 2012. From
...
#' Performance, Institutional Intermediation and Democratic Breakdown," Journal of
#' Politics 63:3 (2001), pp. 775-803. Data and coding description available at
